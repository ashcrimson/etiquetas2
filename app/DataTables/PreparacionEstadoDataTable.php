...
class PreparacionEstadoDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\PreparacionEstado $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PreparacionEstado $model)
    {
    ...
    {
        return 'preparacion_estadosdatatable_' . time();
    }
}
