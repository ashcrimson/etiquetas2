            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.dilucions.store'),data);

                    }else {

                        var res = await axios.patch(route('api.dilucions.update',this.editedItem.id),data);
