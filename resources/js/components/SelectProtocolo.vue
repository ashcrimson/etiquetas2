            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.protocolos.store'),data);

                    }else {

                        var res = await axios.patch(route('api.protocolos.update',this.editedItem.id),data);
