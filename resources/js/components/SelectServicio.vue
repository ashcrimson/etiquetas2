            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.servicios.store'),data);

                    }else {

                        var res = await axios.patch(route('api.servicios.update',this.editedItem.id),data);
