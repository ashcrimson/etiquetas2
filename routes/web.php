...
Route::get('print',function (){
    ...
    $print_data = "^XA
     ...
     ^LH0,0 ^FO4,2 ^GB804,798,4 ^FS ^FO4,2 ^GB548,52,4 ^FS ^FO19,12 ^ADN,36,20 ^FDWena wena ^FS ^FO548,2 ^GB260,52,4 ^FS ^FO561,16 ^ADN,36,10 ^FDP/V ^FS ^FO611,16
^ADN,36,10 ^FD1:3 ^FS ^FO693,16 ^ADN,36,10 ^FD18/12/14 ^FS ^FO20,106 ^GB0,25,50 ^FS
^FO21,150 ^ADN,35,25 ^FR ^FDFELIPE PINO 
^FS ^FO720,66 ^GB72,135,80 ^FS ^FO521,100
^ADN,35,25 ^FR ^FDRX-78 ^FS ^FO4,210 ^GB128,166,4 ^FS ^FO128,210 ^GB680,166,4 ^FS
